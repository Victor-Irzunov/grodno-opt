            ...
            <div className='flex sd:flex-row xz:flex-col sd:space-x-8 xz:space-x-0 sd:space-y-0 xz:space-y-8'>
              <div className=''>
                ...
                <p className='mt-7 text-gray-500 text-sm sd:max-w-2xl xz:max-w-full'>
                  Добро пожаловать в hi3310.ru – ваш надежный оптовый поставщик запасных частей для мобильных телефонов. Мы предлагаем широкий ассортимент качественных комплектующих по выгодным ценам. Надежность и оперативность – наши главные приоритеты!
                </p>
                {
                  user.isAuth ?
