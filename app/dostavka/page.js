  ...
  const options = [
    {
      ...
      description:
        'Мы доставим заказ курьером по Гродно и пригороду. Возможна оплата наличными или картой при получении. Срок доставки — от 2 до 24 часов в зависимости от загруженности.',
    },
    {
