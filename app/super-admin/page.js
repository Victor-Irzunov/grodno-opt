...
import ReturnsAdmin from "@/components/CompAdmin/ReturnsAdmin";
...
function Page() {
  ...
  const renderActiveComponent = () => {
    switch (activeComponent) {
      ...
      case "returns": return <ReturnsAdmin />;
        ...
        <div className="w-1/5 bg-[#202020] border-r border-[#2B2B2B] pt-6 px-8">
          <aside className="sticky top-10">
            ...
            <ul className="text-[#C1C1C1] font-light space-y-3 text-sm mt-20 cursor-pointer">
              <li
                ...
                className={`flex space-x-3 items-center hover:bg-[#191919] py-2 px-3 rounded-md ${
                  activeComponent === "main"
                    ? "border border-primary rounded-md py-2 px-2.5 text-primary bg-[#317bff1a]"
                    : ""
                }`}
              >
                ...
                <div className="collapse">
                  ...
                  <div className="collapse-content pl-10 text-sm">
                    <div
                      ...
                      className={`pl-0.5 ${
                        activeComponent === "addCategory"
                          ? "border border-primary rounded-md text-primary bg-[#317bff1a]"
                          : ""
                      }`}
                    >
                    ...
                    <div
                      ...
                      className={`pl-0.5 ${
                        activeComponent === "AddProductPrice"
                          ? "border border-primary rounded-md text-primary bg-[#317bff1a]"
                          : ""
                      }`}
                    >
                    ...
                    <div
                      ...
                      className={`pl-0.5 ${
                        activeComponent === "AddOneProductAdmin"
                          ? "border border-primary rounded-md text-primary bg-[#317bff1a]"
                          : ""
                      }`}
                    >
                    ...
                    <div
                      ...
                      className={`pl-0.5 ${
                        activeComponent === "UpdateOneProductAdmin"
                          ? "border border-primary rounded-md text-primary bg-[#317bff1a]"
                          : ""
                      }`}
                    >
                    ...
                    <div
                      ...
                      className={`pl-0.5 ${
                        activeComponent === "EditDiscountGroupAdmin"
                          ? "border border-primary rounded-md text-primary bg-[#317bff1a]"
                          : ""
                      }`}
                    >
                ...
                <div className="collapse">
                  ...
                  <div className="collapse-content pl-10 text-sm">
                    ...
                    <div
                      ...
                      className={`pl-0.5 ${
                        activeComponent === "ordersOneClient"
                          ? "border border-primary rounded-md text-primary bg-[#317bff1a]"
                          : ""
                      }`}
                    >
              ...
              <li
                onClick={() => setActiveComponent("contactRequests")}
                className={`flex space-x-3 items-center hover:bg-[#191919] py-2 px-3 rounded-md ${
                  activeComponent === "contactRequests"
                    ? "border border-primary rounded-md py-2 px-2.5 text-primary bg-[#317bff1a]"
                    : ""
                }`}
              >
